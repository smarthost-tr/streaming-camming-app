				...
				<div className="container">
					<div className="row">
						<div className="col-md-12 col-lg-12 col-sm-12">
							<button onClick={() => {
								this.props.history.push(`/profiles/individual/${user.username}`)
							}} className="btn btn-outline green_button_custom" style={{ width: "100%" }}>Visit this users profile - buy additional content</button>
						</div>
					</div>
				</div>
...
export default withRouter(StreamShowSub);